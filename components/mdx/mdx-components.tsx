...
const components: MDXComponents = {
  ...
  p: ({ className, ...props }) => <p className={cx('leading-7 [&:not(:first-child)]:mt-6', className)} {...props} />,
  ul: ({ className, ...props }) => <ul className={cx('my-6 ml-6 list-disc', className)} {...props} />,
  ol: ({ className, ...props }) => <ol className={cx('my-6 ml-6 list-decimal', className)} {...props} />,
  li: ({ className, ...props }) => <li className={cx('mt-2', className)} {...props} />,
